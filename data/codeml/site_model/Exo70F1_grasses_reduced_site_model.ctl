     seqfile = Exo70F1_grasses_reduced.phy  * sequence data file name
    treefile = RAxML_bipartitions.Exo70F1_grasses_reduced  * tree structure file name
     outfile = Exo70F1_grasses_reduced_site_model.mlc  * main result file name
   ...
   CodonFreq = 2   * 0:1/61 each, 1:F1X4, 2:F3X4, 3:codon table
     ...
     NSsites = 0 1 2 7 8  * 0:one w; 1:neutral; 2:positive selection; 3:discrete; 4:freqs;
